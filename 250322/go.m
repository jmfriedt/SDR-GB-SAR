...
cmin=10*log10(0.8*mean(mean(Image_focused(:,(abs(sin_theta)<=1))))); 
cmax=10*log10(0.08*max(max(Image_focused(:,(abs(sin_theta)<=1)))));
caxis([cmin cmax]);

caxis([cmin cmax])
colorbar;shading flat;colormap(jet);
xlabel('x (m)');ylabel('y (m)');
print -dpdfcrop sdr-gb-sar2.pdf
print -r600 -dpng sdr-gb-sar2.png
figure(1)
print -dpdfcrop sdr-gb-sar1.pdf
print -r600 -dpng sdr-gb-sar1.png
save -mat sdr-gb-sar.mat
